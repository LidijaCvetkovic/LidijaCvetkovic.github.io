// Fetch get parameter from url
var url = new URL(window.location.href);
var image_id = url.searchParams.get("id");
var image_container = document.getElementById('photo');
...
// Load image data on load image.html page
                    ...
                    if(image.id == image_id) {                        
                        ...
                        user_list.forEach(function(user){
                            if(image.user_id == user.id) {
                                if(user.image == null) {
                                    author_image.innerHTML = '<a href="users.html?id=' + user.id + '"><img class="author-image" src="img/no-img.png"></a>';
                                } else {
                                    author_image.innerHTML = '<a href="users.html?id=' + user.id + '"><img class="author-image" src="img/' + user.image + '"></a>';
                                }
